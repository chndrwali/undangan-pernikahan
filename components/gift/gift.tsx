  ...
  return (
    <section id="donasi" className="bg-black bg-footer opacity-90 w-full h-screen flex flex-col items-center ">
      <div className="flex flex-col items-center w-full max-w-xl  border-4">
        ...
        <motion.div initial={{ opacity: 0.0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.3, duration: 0.8, ease: 'easeInOut' }} className="w-full max-w-[400px] rounded-2xl">
          <Image src="/home/2.webp" alt="" width={500} height={500} className="object-cover rounded-2xl" />
        </motion.div>
        <motion.div initial={{ opacity: 0.0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.3, duration: 0.8, ease: 'easeInOut' }} className="mt-4 p-4">
